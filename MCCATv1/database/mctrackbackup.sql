...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 19, 2022 at 04:33 AM
...
(17000010, 'Val', 'K', 'Kreuz', '', 'valk@gmail.com', '', '2021-10-06', 'Single', 'M', 'ggdrive@gmail.com/', '09999999999', 'Dog', '94 Pook Dagohoy', 'UP', 'Quezon City', 'Accounting', '2022-01-09', '2022-01-24', 700, '8:00 AM - 5:00 PM', NULL, 'VisVis', '', '', 0, 0, '');
...
INSERT INTO `task` (`task_id`, `efullname`, `dept`, `taskname`, `fformat`, `date_assigned`, `date_submitted`, `gdrvlink`) VALUES
(1, 'Jay Angeles', 'Auxiliary', 'Day 1 Task', 'PNG', '2022-01-01', '2022-01-09 18:36:12', 'https://drive.google.com/file/d/1VvbtDK81KDnIVCj0_8t7LWhnlEeHMKRc/view?usp=sharing'),
(8, 'Vael X Crow X', 'Auxiliary', 'Odl - Day 2 task', 'PPTX', '2022-01-18', '2022-01-15 09:29:00', 'GDrive_Linkhttps://www.youtube.com/');
...
--
ALTER TABLE `task`
  MODIFY `task_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
COMMIT;
